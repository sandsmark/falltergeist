        ...
        Object* ObjectFactory::createObject(unsigned int PID)
        {
            ...
            switch ((OBJECT_TYPE)proto->typeId())
            {
                case OBJECT_TYPE::ITEM:
                {
                    ...
                    auto msg = ResourceManager::get<Format::Msg::File>("text/english/game/pro_item.msg");
                    try
                    {
                ...
                case OBJECT_TYPE::CRITTER:
                {
                    ...
                    auto msg = ResourceManager::get<Format::Msg::File>("text/english/game/pro_crit.msg");
                    try
                    {
                        object->setName(msg->message(proto->messageId())->text());
                        object->setDescription(msg->message(proto->messageId() + 1)->text());
                ...
                case OBJECT_TYPE::SCENERY:
                {
                    ...
                    auto msg = ResourceManager::get<Format::Msg::File>("text/english/game/pro_scen.msg");
                    try
                    {
                        object->setName(msg->message(proto->messageId())->text());
                        object->setDescription(msg->message(proto->messageId() + 1)->text());
                ...
                case OBJECT_TYPE::WALL:
                {
                    ...
                    auto msg = ResourceManager::get<Format::Msg::File>("text/english/game/pro_wall.msg");
                    try
                    {
                        object->setName(msg->message(proto->messageId())->text());
                        object->setDescription(msg->message(proto->messageId() + 1)->text());
                ...
                case OBJECT_TYPE::MISC:
                {
                    ...
                    auto msg = ResourceManager::get<Format::Msg::File>("text/english/game/pro_misc.msg");
                    try
                    {
                        object->setName(msg->message(proto->messageId())->text());
                        object->setDescription(msg->message(proto->messageId() + 1)->text());
